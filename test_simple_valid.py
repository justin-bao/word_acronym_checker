...
def test_add_acronym():
    ...
    temp_path = r'tests/data/temp/test1_add.docx'
    ...
    new_actual_acronyms = ["TLA", "FLA", to_add_acronym]
...
def test_remove_acronym():
    to_remove = "TLA"
    temp_path = r'tests/data/temp/test1_remove.docx'
    copyfile(path, temp_path)
...
def test_processing():
    ...
    temp_path = r'tests/data/temp/test1_process.docx'
    copyfile(path, temp_path)
    document = Document(temp_path)
    document.save(temp_path)
